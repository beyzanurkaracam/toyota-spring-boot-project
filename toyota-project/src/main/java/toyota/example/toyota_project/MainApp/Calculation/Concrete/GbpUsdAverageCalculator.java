...
public class GbpUsdAverageCalculator implements CalculationFormula {
    @Override
    public Map<String, Double> calculate(Map<String, RateFields> dependencies) {
        RateFields pf1 = dependencies.get("PF1_GBPUSD");
        RateFields pf2 = dependencies.get("PF2_GBPUSD");
